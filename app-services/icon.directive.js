myapp.controller('GetIconController', function($scope) {
$scope.icons = [
    {"c": "fa-500px", "l": "500px"},
...
myapp.directive('inputIcon', ['$compile', function($compile) {
   ...
   return {
	...
	controller: "GetIconController",
    compile: function(element, attrs) {

      return function(scope, element, attrs) {
        
        var template = '<input type="text" ng-model="model"  uib-typeahead="icon.c as (icon.c) for icon in icons | filter:$viewValue | limitTo:10" class="class" placeholder="fa-table">';
